...
const ROWS = {
  ...
  'limits.slow.3': ['链接导入长视频：服务器在新加坡，B 站下载约 0.2–1 MB/s，1 小时视频光下载就要半小时以上；请下载后本地上传', 'Long videos by link: the server is in Singapore and Bilibili delivers 0.2–1 MB/s, so a 1-hour video takes over 30 minutes to download; download it and upload the file', 'Långa videor via länk: servern står i Singapore och Bilibili levererar 0,2–1 MB/s, så en timmes video tar över 30 minuter att hämta; ladda ner och ladda upp filen'],
  ...
  'limits.row5.t': ['下载 > 30 分钟', 'Download > 30 min', 'Nedladdning > 30 min'],
  'limits.row5.c': ['—', '—', '—'],
  'limits.row5.n': ['建议下载后本地上传', 'Download it and upload the file instead', 'Ladda ner och ladda upp filen i stället'],
